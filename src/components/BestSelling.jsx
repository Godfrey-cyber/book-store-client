...
const BestSelling = () => {
	...
	return (
		<section className="flex flex-col bg-red-50">
			{/*title*/}
			<p className="flex text-lg font-semibold md:text-xl lg:text-3xl w-full text-red-700 justify-center mx-auto text-center py-8 md:py-12 lg:py-16">Best Selling Books Ever</p>
			{/*//NOVELS*/}
