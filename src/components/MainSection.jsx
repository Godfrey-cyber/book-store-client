			...
			<div className=" bg-white mx-auto w-full lg:w-4/5 h-full">
				<span className=" w-full h-full">
					...
					<span className="mainsection_span">
						...
						<p className="text-sm md:text-lg lg:text-5xl font-bold lg:font-normal text-white">The History</p>
						<p className="text-sm md:text-lg lg:text-5xl font-bold lg:font-normal text-white">of Phipino</p>
